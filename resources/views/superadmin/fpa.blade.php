...
<div class="table-container">
        ...
        @foreach($fpadata as $fpa)
            ...
            <div class="actions">
                    <button class="edit-btn" data-id="{{ $fpa->id_fpa }}"
                        ...
                        <form action="{{ route('superadmin.deletefpa', ['id_fpa' => $fpa->id_fpa]) }}" method="POST"
                            class="delete-form">
                            @csrf
                            @method('DELETE')
    ...
    <div class="form-popup" id="myForm">
                <form action="{{ route('superadmin.addfpa') }}" class="form-container" method="POST">
                    @csrf
...
<script>
                        ...
                        function openFormEdit(button) {
                            ...
                            document.getElementById("editForm").action = "{{ route('superadmin.updatefpa', '') }}/" + button.getAttribute("data-id");
