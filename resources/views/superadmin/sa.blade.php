...
<div class="table-container">
    ...
    <table class="table" id="tables">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <form action="{{ route('superadmin.deletesa', ['id_sa' => $sa->id_sa]) }}" method="POST"
                                        class="delete-form">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="form-popup" id="myForm">
                <form action="{{ route('superadmin.addsa') }}" class="form-container" method="POST">
                    @csrf
                ...
                <form action="" class="form-containerEdit" id="editForm" method="POST">
                    ...
                    <script>
                        ...
                        function openFormEdit(button) {
                            ...
                            document.getElementById("editForm").action = "{{ route('superadmin.updatesa', '') }}/" + button.getAttribute("data-id");
