...
<div class="table-container">
            ...
            <td>
                <div class="actions">
                    <button class="edit-btn" data-id="{{ $rfpa->id_rfpa }}"
                        ...
                        <form action="{{ route('superadmin.deleterfpa', ['id_rfpa' => $rfpa->id_rfpa]) }}" method="POST"
                            class="delete-form">
                            @csrf
                            @method('DELETE')
    ...
    <div class="form-popup" id="myForm">
                <form action="{{ route('superadmin.addrfpa') }}" class="form-container" method="POST">
                    @csrf
...
<script>
                        ...
                        function openFormEdit(button) {
                            ...
                            document.getElementById("editForm").action = "{{ route('superadmin.updaterfpa', '') }}/" + button.getAttribute("data-id");
