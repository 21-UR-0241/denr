...
<div class="table-container">
    ...
    <table class = "table" id = "tables">
        ...
        @foreach($spdata as $sp)
            ...
            <form action="{{ route('superadmin.deletesp', ['id_sp' => $sp->id_sp]) }}" method="POST"
                    class="delete-form">
                        @csrf
                        @method('DELETE')
    ...
    <div class="form-popup" id="myForm">
                <form action="{{ route('superadmin.addsp') }}" class="form-container" method="POST">
                    @csrf
...
+
                        ...
                        document.getElementById("editForm").action = "{{ route('superadmin.updatesp', '') }}/" + button.getAttribute("data-id");
